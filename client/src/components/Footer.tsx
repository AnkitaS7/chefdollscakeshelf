  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: "linear-gradient(90deg, transparent, oklch(0.78 0.1 70 / 0.5), transparent)" }}
      />
      ...
      <div className="container relative z-10 py-14">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
          ...
          <div className="md:col-span-1">
            ...
            <p
              ...
              style={{ color: "oklch(0.70 0.03 40)", fontFamily: "var(--font-body)" }}
            >
              Mumbai's premium home bakery by Dhvani Hariya. Crafting
              100% eggless cakes and desserts with love, passion, and the
              finest ingredients.
            </p>
            <div className="flex items-center gap-1.5 mb-4">
              <MapPin className="w-4 h-4 flex-shrink-0" style={{ color: "oklch(0.72 0.1 10)" }} />
              <span
                className="text-sm"
                style={{ color: "oklch(0.70 0.03 40)", fontFamily: "var(--font-body)" }}
              >
            ...
            <nav className="flex flex-col gap-2">
              {navLinks.map((link) => (
                <Link
                  ...
                  style={{ color: "oklch(0.65 0.03 40)", fontFamily: "var(--font-body)", textDecoration: "none" }}
                >
                  {link.label}
                </Link>
              ))}
            ...
            <div className="flex flex-col gap-2">
              {[
                ...
                <p
                  key={item}
                  className="text-sm"
                  style={{ color: "oklch(0.65 0.03 40)", fontFamily: "var(--font-body)" }}
                >
                  ✦ {item}
                </p>
              ))}
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
          <p
            ...
            style={{ color: "oklch(0.50 0.03 40)", fontFamily: "var(--font-body)" }}
          >
          ...
          <p
            ...
            style={{ color: "oklch(0.50 0.03 40)", fontFamily: "var(--font-body)" }}
          >
            Made with <Heart className="w-3 h-3 text-rose-400" fill="currentColor" /> in Mumbai
          </p>
        </div>
      </div>
    </footer>
