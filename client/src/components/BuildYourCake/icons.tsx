/* =============================================================
   Builder icons - Lucide SVGs for functional UI (steps, products,
   options, actions). Emoji stay in marketing copy and flavor cards,
   where they read as illustration rather than interface.
   ============================================================= */
...
export const PRODUCT_ICONS: Record<ProductType, LucideIcon> = {
  cake: Cake,
  cupcake: Dessert,
  brownie: CakeSlice,
  cookietin: Cookie,
